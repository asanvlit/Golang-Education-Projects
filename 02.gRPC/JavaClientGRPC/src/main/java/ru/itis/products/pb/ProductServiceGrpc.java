...
public final class ProductServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ru.itis.products.pb.ProductRequest,
      ru.itis.products.pb.ProductResponse> METHOD_GET_PRODUCT = getGetProductMethod();

  private static volatile io.grpc.MethodDescriptor<ru.itis.products.pb.ProductRequest,
      ru.itis.products.pb.ProductResponse> getGetProductMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<ru.itis.products.pb.ProductRequest,
      ru.itis.products.pb.ProductResponse> getGetProductMethod() {
    io.grpc.MethodDescriptor<ru.itis.products.pb.ProductRequest, ru.itis.products.pb.ProductResponse> getGetProductMethod;
      ...
      synchronized (ProductServiceGrpc.class) {
        if ((getGetProductMethod = ProductServiceGrpc.getGetProductMethod) == null) {
          ProductServiceGrpc.getGetProductMethod = getGetProductMethod = 
              io.grpc.MethodDescriptor.<ru.itis.products.pb.ProductRequest, ru.itis.products.pb.ProductResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "ProductService", "GetProduct"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.itis.products.pb.ProductRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.itis.products.pb.ProductResponse.getDefaultInstance()))
  ...
  public static abstract class ProductServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getProduct(ru.itis.products.pb.ProductRequest request,
        io.grpc.stub.StreamObserver<ru.itis.products.pb.ProductResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.itis.products.pb.ProductRequest,
                ru.itis.products.pb.ProductResponse>(
  ...
  public static final class ProductServiceBlockingStub extends io.grpc.stub.AbstractStub<ProductServiceBlockingStub> {
    ...
    /**
     */
    public ru.itis.products.pb.ProductResponse getProduct(ru.itis.products.pb.ProductRequest request) {
  ...
  public static final class ProductServiceFutureStub extends io.grpc.stub.AbstractStub<ProductServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.itis.products.pb.ProductResponse> getProduct(
        ru.itis.products.pb.ProductRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT:
          serviceImpl.getProduct((ru.itis.products.pb.ProductRequest) request,
              (io.grpc.stub.StreamObserver<ru.itis.products.pb.ProductResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProductServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.itis.products.pb.Product.getDescriptor();
    }
